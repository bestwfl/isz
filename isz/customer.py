...
def createCustomer():
    ...
    data = {
        ...
        'belong_did':sqlbase.serach("select dep_id from sys_user where user_phone = '13600000001' and user_status = 'INCUMBENCY'")[0],  # 所属部门
        'belong_uid': sqlbase.serach("select user_id from sys_user where user_phone = '13600000001' and user_status = 'INCUMBENCY'")[0],  # 所属人
